...
<nav class="navbar navbar-expand-md navbar-dark mb-4">
    <a href="/" class="navbar-brand"><img src="{{asset('assets/img/artschamps_profile.png')}}" alt="logo" class="img-fluid" width="80px" height="100px"></a>
    ...
    <div class="collapse navbar-collapse" id="responsive">
        <ul class="navbar-nav mr-auto text-capitalize">
            <li class="nav-item"><a href="{{url('/')}}" class="nav-link active" style="color:white; font-weight: bold;">Home</a></li>
            <li class="nav-item"><a href="{{url('/Home/profile')}}" class="nav-link" style="color:white; font-weight: bold;">Profile</a></li>
            <li class="nav-item"><a href="{{url('/Home/messages')}}" class="nav-link" style="color:white; font-weight: bold;">Messages</a></li>
            <li class="nav-item"><a href="{{url('/Home/gallery')}}" class="nav-link" style="color:white; font-weight: bold;">Gallery</a></li>
            <li class="nav-item"><a href="{{url('/Home/messages')}}" class="nav-link d-md-none" style="color:white; font-weight: bold;">Growl</a></li>
        </ul>
        ...
        <div class="dropdown ml-3 d-none d-md-block">
            <a class="nav-link dropdown-toggle" href="#" role="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="" alt="" class="rounded-circle" width="32px" height="32px">
            </a>
