...
class ArtGalleryController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.artist.gallery.index', compact('gallery'));
    }

    public function add()
    {
        $users = DB::table('users')->select('id', 'firstname')->get();
        return view('dashboard.artist.gallery.add', compact('users'));
    }
    ...
    public function store(Request $req)
    {
        ...
        return redirect('dashboard/artist/gallery');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$gallery) {
            return redirect('dashboard/artist/gallery')->with('error', 'Record not found');
        }

        $users = DB::table('users')->select('id', 'firstname')->get();

        return view('dashboard.artist.gallery.edit', compact('gallery', 'users'));
    }
