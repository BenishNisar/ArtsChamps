...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <a href="{{url('/dashboard/admin/notification/')}}" class="btn btn-success"><< Back</a>
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">Notification</h5>
                </div>
                <div class="card-body">
                    <form action="{{ url('/dashboard/admin/notification/store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="is_read" name="is_read" placeholder="Enter if read" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="created_at" name="created_at" placeholder="Enter created at date" required>
                            <div class="invalid-feedback">
