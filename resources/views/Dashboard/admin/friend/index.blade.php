...
@section('AdminContent')
    <div class="container mt-5">
        ...
        <table class="table table-striped table-class" id="table-id1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/dashboard/admin/friend/edit') }}/{{ $item->friend_id }}" class="btn btn-warning">Edit</a>
                        <a href="{{ url('/dashboard/admin/friend/delete') }}/{{ $item->friend_id }}" class="btn btn-danger">Delete</a>
                    </td>
        ...
        <div class="rows_count" id="rows_count">Showing 1 to 5 of {{ count($friend) }} entries</div>
