                ...
                <div class="card-body">
                    <form action="{{ url('/dashboard/admin/users/store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter your name" required>
                            <div class="invalid-feedback">
                                Valid name is required.
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="dob" name="dob" placeholder="Enter your name" required>
                            <div class="invalid-feedback">
                                Valid name is required.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" id="status" name="gender" required>
                                <option value="1">Male</option>
                                <option value="2">Female</option>
                            </select>
                        <div class="mb-3">
                            <label for="name" class="form-label">Phone</label>
                            <input type="number" class="form-control" id="name" name="phone" placeholder="Enter your name" required>
                            <div class="invalid-feedback">
                                Valid name is required.
                            </div>
                        </div>
